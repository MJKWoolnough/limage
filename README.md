...
## Highlights
 ...
 - Create and manipulate layered images.
 - Read and write `.ora` and GIMP `.xcf` files.
 - Supports layer transparency and blending.

## Documentation

Full API docs can be found at:

https://pkg.go.dev/vimagination.zapto.org/limage
